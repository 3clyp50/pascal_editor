...
const VIEW_MODES: { id: ViewMode; label: string; icon: React.ReactNode }[] = [
  {
    ...
    icon: (
      <Image
        ...
        height={14}
        src="/pascal/icons/building.webp"
        width={14}
      />
    ),
  },
  {
    ...
    icon: (
      <Image
        ...
        className="h-3.5 w-3.5 object-contain"
        height={14}
        src="/pascal/icons/blueprint.webp"
        width={14}
      />
    ),
  },
...
const wallModeConfig: Record<string, { icon: string; label: string }> = {
  up: { icon: '/pascal/icons/room.webp', label: 'Full height' },
  cutaway: { icon: '/pascal/icons/wallcut.webp', label: 'Cutaway' },
  down: { icon: '/pascal/icons/walllow.webp', label: 'Low' },
  translucent: { icon: '/pascal/icons/wall.webp', label: 'Translucent' },
}
