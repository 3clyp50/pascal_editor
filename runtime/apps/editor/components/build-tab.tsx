...
const BASE_BUILD_TYPES: BuildType[] = [
  { id: 'wall', label: 'Wall', iconSrc: '/pascal/icons/wall.webp', kind: 'wall' },
  { id: 'fence', label: 'Fence', iconSrc: '/pascal/icons/fence.webp', kind: 'fence' },
  { id: 'slab', label: 'Slab', iconSrc: '/pascal/icons/floor.webp', kind: 'slab' },
  { id: 'ceiling', label: 'Ceiling', iconSrc: '/pascal/icons/ceiling.webp', kind: 'ceiling' },
  { id: 'roof', label: 'Roof', iconSrc: '/pascal/icons/roof.webp', kind: 'roof' },
  { id: 'stair', label: 'Stairs', iconSrc: '/pascal/icons/stairs.webp', kind: 'stair' },
  { id: 'elevator', label: 'Elevator', iconSrc: '/pascal/icons/elevator.webp', kind: 'elevator' },
  { id: 'door', label: 'Door', iconSrc: '/pascal/icons/door.webp', kind: 'door' },
  { id: 'window', label: 'Window', iconSrc: '/pascal/icons/window.webp', kind: 'window' },
  { id: 'column', label: 'Column', iconSrc: '/pascal/icons/column.webp', kind: 'column' },
  { id: 'shelf', label: 'Shelf', iconSrc: '/pascal/icons/shelf.webp', kind: 'shelf' },
  { id: 'spawn', label: 'Spawn Point', iconSrc: '/pascal/icons/spawn-point.webp', kind: 'spawn' },
  { id: 'kitchen', label: 'Kitchen', iconSrc: '/pascal/icons/kitchen.webp' },
  // Group tile — no tool of its own; opens the MEP sub-grid below (like Roof).
  { id: 'mep', label: 'MEP', iconSrc: '/pascal/icons/HVAC.webp' },
  { id: 'painting', label: 'Painting', iconSrc: '/pascal/icons/paint.webp', mode: 'material-paint' },
  { id: 'terrain', label: 'Terrain', iconSrc: '/pascal/icons/mesh.webp', mode: 'terrain-sculpt' },
]
...
function collectBuildTypes(floorplanMode: FloorplanMode): BuildType[] {
  ...
  for (const [kind, definition] of nodeRegistry.entries()) {
    ...
    tools.push({
      ...
      iconSrc: presentation.icon.kind === 'url' ? presentation.icon.src : '/pascal/icons/spawn-point.webp',
...
const MEP_ITEMS: MepItem[] = [
  { id: 'duct-segment', label: 'Duct', iconSrc: '/pascal/icons/duct.webp', kind: 'duct-segment' },
  {
    id: 'duct-terminal',
    label: 'Register',
    iconSrc: '/pascal/icons/registers.webp',
    kind: 'duct-terminal',
  },
  { id: 'hvac-equipment', label: 'HVAC Unit', iconSrc: '/pascal/icons/HVAC.webp', kind: 'hvac-equipment' },
  { id: 'lineset', label: 'Lineset', iconSrc: '/pascal/icons/lineset.webp', kind: 'lineset' },
  { id: 'liquid-line', label: 'Liquid Line', iconSrc: '/pascal/icons/lineset.webp', kind: 'liquid-line' },
  { id: 'pipe-segment', label: 'DWV Pipe', iconSrc: '/pascal/icons/dwv-pipes.webp', kind: 'pipe-segment' },
]

const MODULAR_CABINET_CATALOG_ITEM = CATALOG_ITEMS.find((item) => item.id === 'cabinet')
const MODULAR_CABINET_ICON = MODULAR_CABINET_CATALOG_ITEM?.thumbnail ?? '/pascal/icons/item.webp'
...
const ROOF_FEATURE_FALLBACK_ICON = '/pascal/icons/roof.webp'
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                <Image
                  ...
                  height={16}
                  src="/pascal/icons/duct-fitting.webp"
                  width={16}
                />
                Add Fitting
              </button>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                <Image
                  ...
                  className="size-4 object-contain"
                  height={16}
                  src="/pascal/icons/dwv-pipes.webp"
                  width={16}
                />
                Add Trap
              </button>
